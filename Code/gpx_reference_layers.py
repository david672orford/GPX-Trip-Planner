...
layers = (
	...
	GpxTileLayer(2, _("OSM Thunderforest Transport Dark"), "osm-thunderforest-transport-dark"),
	GpxTileLayer(2, _("OSM Thunderforest Pioneer"), "osm-thunderforest-pioneer"),
	GpxTileLayer(1, _("OSM Thunderforest Mobile Atlas"), "osm-thunderforest-mobile-atlas"),
